...
export class ExerciceSuccessRepositoryFake
    ...
    private exercices = [
        {
            ...
            image:
                "https://i0.wp.com/muscu-street-et-crossfit.fr/wp-content/uploads/2022/03/Muscles-DM-Halteres.002.jpeg",
    ...
    async update(
        ...
        //todo fix type
        this.exercices = this.exercices.map((exercice) =>
            exercice.id === exerciceId ? exerciceUpdated : exercice,
        );
    }
